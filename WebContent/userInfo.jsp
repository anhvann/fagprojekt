	...
	<div class="main" >
			...
			<hr width="95%" noshade>
				<form action="UserActivity" method="post" target="_self">
					...
					<div class="col-sm-5"><input type="number" class="form-control" id="phone" placeholder="Enter Phone" value="${phone}"></div>
					<br><br>
					...
					<div class="col-sm-5"><input type="text" class="form-control" id="city" readonly="readonly" value="${city}"></div>
					<br><br>
